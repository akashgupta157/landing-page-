          ...
          <div className="flex flex-wrap items-center gap-5">
            {["Privacy Policy", "Terms of Use", "Status"].map((label) => (
              <Link
                key={label}
                href="#"
                className="cursor-pointer text-xs text-white/42 transition-colors duration-300 hover:text-white"
              >
                {label}
              </Link>
            ))}
          ...
          <div className="flex items-center gap-3">
            {["X", "Linkedin", "Github"].map((label) => (
              <a
                ...
                className="cursor-pointer inline-flex size-10 items-center justify-center rounded-full border border-white/8 bg-white/[0.03] text-[11px] uppercase tracking-[0.18em] text-white/45 transition-all duration-300 hover:border-white/16 hover:text-white"
              >
                {label === "X" ? (
                  <svg
