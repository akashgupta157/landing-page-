      ...
      <DialogContent className="sm:max-w-md bg-[#111] border-white/10 text-white">
        <DialogHeader className="text-center">
          ...
          <DialogDescription className="text-white/50 text-sm">
            Unlock your full AEO report and optimization roadmap.
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={handleEmailSubmit} className="flex flex-col gap-3">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-white/5 border-white/10 text-white placeholder:text-white/30 focus:border-[#c8f538] focus:ring-[#c8f538]/20"
              />
            </div>
            <Button
              type="submit"
              className="w-full bg-[#c8f538] text-black font-semibold hover:opacity-90"
            >
              Continue with Email
            </Button>
          </form>
